...
```{r bump-chart-rankings, fig.width=7, fig.height=10}
sg_data <- readRDS("data/sg_data.rds")
...
# ggplot(data = sg_rank_long, aes(x = Date, y = Rank, group = Staticgen)) +
#   geom_line(aes(color = Staticgen, alpha = 1), size = 2) +
#   geom_point(aes(color = Staticgen, alpha = 1), size = 4) +
...
# show.top.n <- 18
# day <- rep(c(1,2,3,4,5,6,7), 18)
# sg_rank_long <- cbind(sg_rank_long, day)

# ggplot(data = sg_rank_long, aes(x = as.numeric(as.Date(Date, origin = as.Date("1970-01-01"))), y = Rank, group = Staticgen)) +
#   geom_line(aes(color = Staticgen, alpha = 1), size = 2) +
#   geom_point(aes(color = Staticgen, alpha = 1), size = 4) +
#   geom_point(color = "#FFFFFF", size = 1) +
#   scale_y_reverse(breaks = 1:show.top.n) +
#   scale_x_continuous(breaks = 1:7, minor_breaks = 1:7, expand = c(.05, .05)) +
#   geom_text(data = sg_rank_long %>% filter(Date == "2014-05-30"),
#             aes(label = Staticgen, x = 0.5) , hjust = .85, fontface = "bold", color = "#888888", size = 4) +
#   geom_text(data = sg_rank_long %>% filter(Date == "2019-07-30"),
#             aes(label = Staticgen, x = 16.5) , hjust = 0.15, fontface = "bold", color = "#888888", size = 4) +
...
# sg.rankings <- sg_rank_long %>%
#   group_by(Date) %>%
#   arrange(Date, Staticgen) %>%
...
```{r draw-bump-chart, , fig.width=9, fig.height=10}
# day <- rep(c(1,2,3,4,5,6,7), 18)
# sg_rank_long <- cbind(sg_rank_long, day)
...
# show.top.n <- 18
# ggplot(data = sg_rank_long, aes(x = as.numeric(as.Date(Date)), y = Rank, group = Staticgen)) +
#   geom_line(aes(color = Staticgen, alpha = 1), size = 2) +
#   geom_point(aes(color = Staticgen, alpha = 1), size = 4) +
#   geom_point(color = "#FFFFFF", size = 1) +
#   scale_y_reverse(breaks = 1:show.top.n) +
